<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="LinkRetrieverTryIt._Default" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
     ...
     <asp:Panel runat="server" ID="userInput" CssClass="jumbotron" BorderWidth="5">
         ...
         <br />
         <asp:TextBox ID="urlInput" runat="server" />
         <br />
